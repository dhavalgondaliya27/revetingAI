...
def send_email(
    ...
    message["Subject"] = f"""{name} has invited you to "{documentTeamName}""" ""
...
<body>
    <div class="emailsection">
        <div class="head">
            ...
            <h2>
                <span>{name}</span> has invited you to <br />
                 “{documentTeamName}”
            </h2>
        </div>
        <div class="emailcontent">
            <p>Hello,</p>
            <p>
                You’ve been invited to join <span>{name}</span>’s document team titled <span>{documentTeamName}.</span>
            </p>
            <p>Click the link below to securely join this document team where you can access, review, and edit your teams’ documents</p>
        </div>
        <div class="subcontent">
            <div class="firstlink">
                <a href="http://localhost:8000/register?team_token={teamToken}" class="linkbtn">Click to Access {firstName}'s Team</a>
            </div>
